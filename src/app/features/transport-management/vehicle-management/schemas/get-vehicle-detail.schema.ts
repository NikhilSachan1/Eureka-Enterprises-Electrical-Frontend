...
export const VehicleDetailGetVersionHistorySchema =
  VehicleDetailGetBaseResponseSchema.omit({
    ...
    .extend({
      ...
      insuranceStartDate: onlyDateStringField.nullable(),
      insuranceEndDate: onlyDateStringField.nullable(),
      pucStartDate: onlyDateStringField.nullable(),
      pucEndDate: onlyDateStringField.nullable(),
