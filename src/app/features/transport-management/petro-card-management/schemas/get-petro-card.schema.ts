...
export const PetroCardGetBaseResponseSchema = z.looseObject({
...
export const PetroCardGetStatsResponseSchema = z.looseObject({
...
export const PetroCardGetResponseSchema = z.looseObject({
  ...
  stats: PetroCardGetStatsResponseSchema,
