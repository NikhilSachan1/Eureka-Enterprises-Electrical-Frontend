...
const buildReportTableRowActionsConfig = (
  ...
  },
  {
    ...
    disableWhen: shouldDisableReportApprove,
    disableReason: reportApproveDisableReason,
    permission: [APP_PERMISSION.REPORT_DOC.APPROVE],
  },
  {
    ...COMMON_ROW_ACTIONS.REJECT,
    tooltip: 'Reject report',
    disableWhen: shouldDisableReportReject,
    disableReason: reportRejectDisableReason,
    permission: [APP_PERMISSION.REPORT_DOC.REJECT],
  },
  {
