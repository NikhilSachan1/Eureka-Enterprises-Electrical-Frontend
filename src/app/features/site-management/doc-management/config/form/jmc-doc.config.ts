...
import { IJmcDocAddUIFormDto } from '../../types/doc.dto';

const JMC_DOC_FORM_FIELDS_CONFIG: IFormInputFieldsConfig<IJmcDocAddUIFormDto> =
  {
    poNumber: {
...
export const JMC_DOC_FORM_CONFIG: IFormConfig<IJmcDocAddUIFormDto> = {
