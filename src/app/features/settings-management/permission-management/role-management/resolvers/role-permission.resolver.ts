...
import { IGetRolePermissionRequestDto, IGetRolePermissionsResponseDto } from "@features/settings-management/permission-management/role-management/models/role-permission.api.model";
