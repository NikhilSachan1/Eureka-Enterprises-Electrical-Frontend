...
} from '@features/settings-management/permission-management/shared/set-permission/component/set-permission.component';
...
export class SetRolePermissionComponent implements OnInit {
  ...
  private loadRolePermissionDataFromRoute(): void {
    const rolePermissionRouteData = this.activatedRoute.snapshot.data[
      'rolePermissionData'
    ] as IGetRolePermissionsResponseDto | null;
  ...
  private prepareRolePermissionData(
    rolePermissionRouteData: IGetRolePermissionsResponseDto
