...
export const AssetDetailGetVersionHistorySchema =
  AssetDetailGetBaseResponseSchema.omit({
    ...
    .extend({
      calibrationStartDate: onlyDateStringField.nullable(),
      calibrationEndDate: onlyDateStringField.nullable(),
      purchaseDate: onlyDateStringField,
      warrantyStartDate: onlyDateStringField.nullable(),
      warrantyEndDate: onlyDateStringField.nullable(),
