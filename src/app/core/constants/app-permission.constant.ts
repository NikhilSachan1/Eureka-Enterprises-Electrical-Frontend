...
export const APP_PERMISSION = {
  ...
  PAYMENT_SHEET: {
    ...
    BENEFICIARY_ADD: 'financials.payment-sheets.beneficiary-add',
    BENEFICIARY_EDIT: 'financials.payment-sheets.beneficiary-edit',
    BENEFICIARY_REMOVE: 'financials.payment-sheets.beneficiary-remove',
